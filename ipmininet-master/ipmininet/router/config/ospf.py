...
class OSPF(QuaggaDaemon):
    ...
    def _build_networks(interfaces: List[IPIntf]) -> List['OSPFNetwork']:
        """Return the list of OSPF netwopriorityrks to advertize from the list of
    ...
    def set_defaults(self, defaults):
        ...
        :param redistribute: set of OSPFRhttps://pexpect.readthedocs.io/en/stable/edistributedRoute sources"""

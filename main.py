...
class SimpleBGPTopo(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        l_MRS1_MRS2 = self.addLink(
            MRS1, MRS2, igp_metric=2, password=OSPF_PW_EU, key=EU_key)
        ...
        l_SIN1_SIN2 = self.addLink(
            SIN1, SIN2, igp_metric=2, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_SYD1_SYD2 = self.addLink(
            SYD1, SYD2, igp_metric=2, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_PAR1_PAR2 = self.addLink(
            PAR1, PAR2, igp_metric=2, password=OSPF_PW_EU, key=EU_key)
        ...
        l_ASH1_ASH2 = self.addLink(
            ASH1, ASH2, igp_metric=2, password=OSPF_PW_NA, key=NA_key)
        ...
        l_LAX1_LAX2 = self.addLink(
            LAX1, LAX2, igp_metric=2, password=OSPF_PW_NA, key=NA_key)
        ...
        l_SJO1_SJO2 = self.addLink(
            SJO1, SJO2, igp_metric=2, password=OSPF_PW_NA, key=NA_key)
        ...
        l_MRS1_SIN1 = self.addLink(
            MRS1, SIN1, igp_metric=20, password=OSPF_PW_EU, key=EU_key)
        ...
        l_MRS2_SIN2 = self.addLink(
            MRS2, SIN2, igp_metric=26, password=OSPF_PW_EU, key=EU_key)
        ...
        l_SIN1_SYD1 = self.addLink(
            SIN1, SYD1, igp_metric=3, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_SIN2_SYD2 = self.addLink(
            SIN2, SYD2, igp_metric=3, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_SIN2_SJO1 = self.addLink(
            SIN2, SJO1, igp_metric=20, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_SIN1_SJO2 = self.addLink(
            SIN1, SJO2, igp_metric=20, password=OSPF_PW_AS, key=ASIA_key)
        ...
        l_ASH1_LAX1 = self.addLink(
            ASH1, LAX1, igp_metric=3, password=OSPF_PW_NA, key=NA_key)
        ...
        l_ASH2_LAX2 = self.addLink(
            ASH2, LAX2, igp_metric=3, password=OSPF_PW_NA, key=NA_key)
        ...
        l_ASH1_LAX2 = self.addLink(
            ASH1, LAX2, igp_metric=3, password=OSPF_PW_NA, key=NA_key)
        ...
        l_SJO1_LAX1 = self.addLink(
            SJO1, LAX1, igp_metric=3, password=OSPF_PW_NA, key=NA_key)
        ...
        l_SJO2_LAX2 = self.addLink(
            SJO2, LAX2, igp_metric=3, password=OSPF_PW_NA, key=NA_key)
        ...
        l_PAR1_ASH1 = self.addLink(
            PAR1, ASH1, igp_metric=20, password=OSPF_PW_EU, key=EU_key)
        ...
        l_PAR2_ASH2 = self.addLink(
            PAR2, ASH2, igp_metric=20, password=OSPF_PW_EU, key=EU_key)
        ...
        l_PAR1_MRS2 = self.addLink(
            PAR1, MRS2, igp_metric=3, password=OSPF_PW_EU, key=EU_key)
        ...
        l_PAR2_MRS1 = self.addLink(
            PAR2, MRS1, igp_metric=3, password=OSPF_PW_EU, key=EU_key)
        ...
        l_SYD2_LAX2 = self.addLink(
            SYD2, LAX2, igp_metric=20, password=OSPF_PW_AS, key=EU_key)
        ...
        S1 = self.addRouter("S1", config=RouterConfig, lo_addresses=[
                            server_ipv6 + "::/64", server_ipv4 + "1/32"])
        S2 = self.addRouter("S2", config=RouterConfig, lo_addresses=[
                            server_ipv6 + "::/64", server_ipv4 + "1/32"])

        # Adding BGP daemons to manage failures

        S1.addDaemon(BGP, address_families=(
            AF_INET6(redistribute=['connected']), AF_INET(redistribute=['connected'])))
        S2.addDaemon(BGP, address_families=(
            AF_INET6(redistribute=['connected']), AF_INET(redistribute=['connected'])))
        ...
        l_S1_SJO2[S1].addParams(
            ip=(server_ipv6 + "a1a::1/64", server_ipv4 + "5/30"))
        l_S1_SJO2[SJO2].addParams(
            ip=(server_ipv6 + "a1a::2/64", server_ipv4 + "6/30"))

        l_S2_PAR2 = self.addLink(S2, PAR2, igp_metric=3)
        l_S2_PAR2[S2].addParams(
            ip=(server_ipv6 + "a1a::3/64", server_ipv4 + "9/30"))
        l_S2_PAR2[PAR2].addParams(
            ip=(server_ipv6 + "a1a::4/64", server_ipv4 + "10/30"))
...
if __name__ == '__main__':
    ...
    try:
        net.start()
        servers = [('S2', '1627:6000:0:3a1a::3'),
                   ('S1', '1627:6000:0:3a1a::1')]
        sRouters = [('PAR2', '1627:6000:0:3a1a::4'),
        ...
        routeurList = ['PAR1', 'PAR2', 'SIN1', 'SIN2', 'SYD1', 'SYD2',
                       ...
                       'EQXSIN1', 'EQXSYD2', 'NTTSYD1', 'NTTSYD2', 'S1', 'S2']

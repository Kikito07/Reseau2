...
class SimpleBGPTopo(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        # routers of MRS
        MRS1 = self.addRouter("MRS1",config=RouterConfig)
        MRS2 = self.addRouter("MRS2",config=RouterConfig)
         #routers of PAR
        PAR1 = self.addRouter("PAR1",config=RouterConfig)
        PAR2 = self.addRouter("PAR2",config=RouterConfig)
        # routers of SIN
        ...
        SJO2 = self.addRouter("SJO2",config=RouterConfig)
        #routers of ASH
        ...
        l_PAR1_MRS2 = self.addLink(PAR1,MRS2,igp_cost=4)
